...
const Header = (prop) => {
  ...
  useEffect(() => {
    if (userData?.profile_image) {
      setProfileImage(userData.profile_image); // Set the profile image once userData is available
    }
        ...
        <div className='profileCartOrder'>
          ...
          <h2 className='profile'>
            {profileImage ? (
              ...
              <span>No Profile</span> // Fallback if profile_image is not available
            )}
          </h2>
        </div>
      </div>
